...
Definición: desde la PRIMERA entrada a Doing hasta la PRIMERA entrada a
...
de tarjeta viene del evento de creación (meta.tipoTarjeta).
Colección: eventos. El filtro por proyecto entra como lista de sprintIds
...
def pipeline_cycle_time(sprint_ids):
    return [
        ...
        # La creación no se filtra por sprint a propósito: una tarjeta
        # nacida en el backlog tiene creacion.meta.sprintId = null y perdería su
        # tipo al entrar al sprint. Las tarjetas de otros proyectos
